// Q.4 create a class car if the car model and milage of the car is given as input find the car model whose milage is highest and display both the car model and milage if the 7 enteries are given as input to the program use array of objects.
